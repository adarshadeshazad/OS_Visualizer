        ...
        <div>
            <div className="jumbotron bg-transparent">
                <div className="container">
                    ...
                    <p className="lead">Memory Management OS</p>
                </div>
            </div>
            ...
            <button type="button" className={"btn btn-danger mt-2 me-2"} onClick={handleRefStringGenClick}>Generate String</button>
            <button type="button" className={!swapToggle?"btn btn-secondary mt-2 me-2":"btn btn-outline-secondary mt-2 me-2"} onClick={handleSwapToggle}>{swapToggle?"Hide swapped out memory" : "Show swapped out memory"}</button>
            <button type="button" className={!animationToggle?"btn btn-success mt-2 me-2":"btn btn-outline-success mt-2 me-2"} onClick={handleAnimationToggle}>{animationToggle?"Turn off animation" : "Turn on animation"}</button>
            {/* <button type="button" className={!detailToggle?"btn btn-info mt-2 me-2":"btn btn-outline-info mt-2 me-2"} onClick={handleDetailToggle}>{detailToggle?"Hide details" : "Show details"}</button> */}
            <HelpModal/>
        </div>
    )
    }
